...
{{
  ...
  "shipping_info": "7-11 門市資訊提取規則：1. 優先權高：尋找 6 位數純數字【店號】(通常在條碼旁、店號標籤後或收據底部)。2. 優先權中：尋找包含『7-ELEVEN』與『門市』的標題 (如：7-ELEVEN 旗山旗力門市)。3. 禁止提取：發票號碼(字母+8位)、統編(8位)、民國年度(113年)、機號(4位)、完整地址。若同時有店名與6位店號請回傳『店名(店號)』。",
  "items": [
